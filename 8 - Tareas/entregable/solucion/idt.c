...
#define IDT_ENTRY3(numero)                                                     \
  idt[numero] = (idt_entry_t) {                                                \
    .offset_31_16 = HIGH_16_BITS(&_isr##numero),/* que re contra carajeanos la sintaxis esta (&_isr##numero) */ \
    .offset_15_0 = LOW_16_BITS(&_isr##numero),                                 \
    .segsel = GDT_CODE_0_SEL,                                                  \
    .type = 0xE,                                                               \
    .dpl = 3,                                                                  \
...
void idt_init() {
  ...
  // COMPLETAR: Interrupciones de reloj y teclado - 32 a 255 user defined interrupts?

  IDT_ENTRY0(32); // Interrupcion de reloj
  IDT_ENTRY0(33); // Interrupcion de teclado
