...
modo_protegido:
    ...
    lea ebp, [esp]    ; Establecer la base de la pila en la misma dirección que el tope de la pila
    ...
    call tss_init           ; Agrego tarea idle e inicial a la gdt

    call tasks_screen_draw  ; Inicializo la pantalla de tareas.

    mov di, 11 << 3
    or di, 0x3
    ltr di                  ; Cargo el selector de la tarea inicial en TR

    mov ax, 5000            ; Modifico el reloj
    out 0x40, al
    rol ax, 8
    out 0x40, al
