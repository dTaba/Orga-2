...
#define GDT_DATA_0_SEL (GDT_IDX_CODE_3 << 3)
...
// SEGM_LIMIT_4KIB es el limite de segmento visto como bloques de 4KIB GDT_IDX_CODE_0 1
...
#define DESC_CODE_DATA 0x0
#define DESC_SYSTEM 0x1
